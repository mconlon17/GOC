...
```
```{r matches}
  matches <- data.frame(last_name = c(
  "Baker", "Bernard", "Bernard", "Best", "Best", "Fishman", "Handley", "Jenkins", "Lyons", "Poindexter-Jones", 
  "Waitcus", "Walker", "Blischak", "Boulet", "Broaudes", "Hurtt", "Kurfiss", "Orsini", "Schreiber", "Smith", 
  "Stevens", "Sugar", "Turull", "Zaatari", "Calixte", "Churn", "Davidsen", "Dunbar", "Herrington", "Jones", 
  "Lovely", "Roberts", "Robertson", "Scott", "Sullivan", "Thurston", "Bateman", "Curry", "Dewberry", "Ferreiro", 
  "Hayes", "Leacock", "Lillie", "Nelson-Gent", "Rana", "Thomas", "Williams", "Babcock", "Chalk", "Crawford", 
  "Delotelle", "Devaney", "Dunnam", "Henderson", "Legacy", "Leyman", "McKay", "Reynolds", "Sanders", "Williams", 
  "Benson", "Call", "Castle", "Hesch", "Johnson", "McCook", "McMullen", "Montague", "Rhodes", "Scannell", 
  "Scannell", "Siegel", "Wagoner", "Watson"),
  first_name = c(
  "Jerry", "Edward", "Jane", "Deborah", "Zennie", "Marie", "Jonathan", "Joevan", "Mark", "Ryan", 
  "John", "Rose Ann", "Svetlana", "Lloyd", "Joanna", "Kelly Anne", "Judy", "Dominic", "Reid", "John", 
  "David", "Kim", "David", "Maryann", "David", "Jonesha", "Jeffry", "Jaqueline", "Gillian", "Lori", 
  "Karen", "Lasheka", "Phillip", "Dakota", "Julia", "Ben", "Patricia", "Bonnie", "Janeequa", "Caridad", 
  "James", "Marcelle", "Phillip", "Tarrica", "Daoud", "Susan", "Kyana", "Amber", "Eddie", "Daniel", 
  "William David", "Melissa", "Mackenzie", "Alexis", "Neil", "Michael", "Karen", "Grenesia", "Valerie", "Diana", 
  "Kristy", "Susan", "Jordan", "Scott", "Akeem", "James", "William", "David", "Christopher", "Pamela",  
  "Steve", "Sean", "Christopher", "Early"),
  staff_name = c(
  "Brett", "Brett", "Brett", "Brett", "Brett", "Brett", "Brett", "Brett", "Brett", "Brett", 
  "Brett", "Brett", "Cristina", "Cristina", "Cristina", "Cristina", "Cristina", "Cristina", "Cristina", "Cristina", 
  "Cristina", "Cristina", "Cristina", "Cristina", "Kaitlyn", "Kaitlyn", "Kaitlyn", "Kaitlyn", "Kaitlyn", "Kaitlyn", 
  "Kaitlyn", "Kaitlyn", "Kaitlyn", "Kaitlyn", "Kaitlyn", "Kaitlyn", "Mia", "Mia", "Mia", "Mia", 
  "Mia", "Mia", "Mia", "Mia", "Mia", "Mia", "Mia", "Paul", "Paul", "Paul", 
  "Paul", "Paul", "Paul", "Paul", "Paul", "Paul", "Paul", "Paul", "Paul", "Paul", 
  "Rob", "Rob", "Rob", "Rob", "Rob", "Rob", "Rob", "Rob", "Rob", "Rob", 
  "Rob", "Rob", "Rob", "Rob"))

# ft <- goc.table(matches, paste0(nrow(matches), " Matches"))
# ft
```
```{r rel}
...
members <- get.members(active.only=T) %>%
  select(id, contact_id_c, first_name, last_name) %>%

  # Add the Assignments
  
  left_join(matches, by=c("last_name"="last_name", "first_name"="first_name")) %>%
