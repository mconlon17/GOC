...
allergies <- read_csv("../../data/applistic-final/people.csv", col_types = list(
  ...
  filter(ConditionsAllergies != "" & !is.na(ConditionsAllergies)) %>%
...
ft <- goc.table(allergies, paste("Allergies", today()))
ft
```
