  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(
        ...
        box(title = "Amazing Give Results 4/21", background = "navy", width = 4,
          p("$33,661 at 5:30 pm. See",a("GOC at the Amazing Give",href="https://www.theamazinggive.org/organizations/gainesville-opportunity-center"))),
