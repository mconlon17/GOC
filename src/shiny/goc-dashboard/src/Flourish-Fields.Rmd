...
contact_fields[contact_fields$field_name == "c2_primary_phone", seq(3, 5)] <- c("unused","Unused","Unused")
contact_fields[contact_fields$field_name == "c2_secondary_phone", seq(3, 5)] <- c("unused","Unused","Unused")
