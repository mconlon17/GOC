---
title: Accessibility Restrictions
output:
    html_document:
...
select(first_name, last_name, flo_accessibility_restrictions) %>%
rename(`First Name` = first_name, `Last Name` = last_name, `Accessibility Restrictions` = flo_accessibility_restrictions)
